    ...
    def run(self, ):
        ...
        while True:
            ...
            for i in range(len(MAIN_MENU_OPT)):
                self.menu_text(MENU_OPT_SIZE, MAIN_MENU_OPT[i], NEON_SALMON, (WIN_WIDTH/2, 250 + 35 * i) )

            # sign
            self.menu_text(
                text_size=SIGN_SIZE, text='Created by: pgmatheus-code', text_color=NEON_SALMON,
                text_center_pos=(WIN_WIDTH - 110, WIN_HEIGHT - SIGN_SIZE)
            )
